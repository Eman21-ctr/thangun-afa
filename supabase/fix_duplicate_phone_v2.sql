-- FINAL FIX FOR REGISTRATION
-- Removes 'is_superuser' which doesn't exist in some Supabase versions
-- Also keeps the duplicate phone cleanup logic
...
BEGIN
    ...
    -- 4. Create user in auth.users (Removed is_superuser column)
