    ...
    return (
        <div className="p-5 space-y-6 font-sans">
            ...
            <div className="bg-white p-5 rounded-2xl border border-primary-100/50 shadow-sm flex items-center space-x-4">
                <div className="w-14 h-14 bg-primary rounded-xl flex items-center justify-center text-white text-xl font-semibold border-2 border-white shadow-lg flex-shrink-0">
